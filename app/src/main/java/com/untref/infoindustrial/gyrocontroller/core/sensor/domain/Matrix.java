package com.untref.infoindustrial.gyrocontroller.core.sensor.domain;

public class Matrix {

    private static final float[] TEMP_MATRIX_ARRAY = new float[32];

    public static void multiplyMM(float[] output, int outputOffset, float[] lhs, int lhsOffset, float[] rhs, int rhsOffset) {
